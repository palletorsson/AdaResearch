...
Trace asked what a record can retain of a gesture. Grid asks when differences between positions should count, and who gets to make that choice. The question begins with a small action: move while keeping the same coarse address. There is activity here that this particular record can afford to leave out.
