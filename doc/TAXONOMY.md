...
|---|---|---|---:|---:|---:|---|---|
| 1 | `primitives` | `F_order` | 11 | 11 | 0 | `Point_One` | `Random_Rotate_Random_XYZ`, `attachable_wood_cube`, `binary_table`, `index_visualizer` |
| 2 | `transformation` | `F_order` | 8 | 8 | 0 | `Structure_Examples` | `transformation_workbench`, `transform_matrix_cube`, `vector_translation_demo`, `vector_addition_demo` |
| 3 | `wavefunctions` | `oscillation` | 12 | 12 | 0 | `WaveFunctions_Intro` | `coupled_pendulums`, `living_paper_fourier`, `living_paper_heat`, `living_paper_lissajous` |
...
| 5 | `randomness` | `E_entropy` | 13 | 13 | 0 | `Random_Definition` | `monte_carlo_estimator`, `distribution_sampler`, `random_walk_terrarium`, `grid3d_entropy` |
| 6 | `noise` | `E_entropy` | 8 | 8 | 0 | `Random_Noise_Types` | `flow_field_painter`, `perlin_terrain_sculptor`, `living_paper_noise_octaves`, `living_paper_perlin` |
| 7 | `cellularautomata` | `E_entropy` | 12 | 12 | 0 | `CA_1` | `ca_rule_explorer`, `game_of_life_petri`, `grid2d_brians_brain`, `grid2d_life` |
| 8 | `fractals` | `lambda_edge` | 14 | 14 | 0 | `Fractals_1` | `julia_set_explorer`, `mandelbrot_dive`, `living_paper_julia`, `living_paper_koch` |
| 9 | `lsystems` | `lambda_edge` | 12 | 12 | 0 | `LSystems_Hilbert3D` | `living_paper_dragon`, `living_paper_fern`, `living_paper_tree`, `lsystem_editor` |
| 10 | `proceduralgeneration` | `lambda_edge` | 18 | 18 | 0 | `ProceduralGeneration_Two` | `pixel_cloud`, `plane_manipulator`, `ten_print_maze_3d`, `2d_in_3d_randomness_vis` |
| 11 | `morphogenesis` | `integration` | 2 | 2 | 0 | `ProceduralGeneration_Reaction_Diffusion_Systems` | `turing_pattern_generator`, `shader_10_reactiondiffusion` |
| 12 | `swarmintelligence` | `integration` | 7 | 7 | 0 | `SwarmIntelligence_PhysarumColony` | `boids_aquarium`, `pheromone_terrain` |
| 13 | `softbodies` | `integration` | 8 | 8 | 0 | `SoftBodies_Carusell` | `jelly_cube`, `jelly_variants` |
| 14 | `machinelearning` | `integration` | 18 | 18 | 0 | `MachineLearning_Evolving_Creatures` | `living_paper_kmeans`, `profile_gradient_descent`, `transformation_workbench` |
| 15 | `foundationscrisis` | `synthesis` | 8 | 8 | 0 | `Euclid_Parallel` | `euclid_postulates_plaque`, `escher_staircase`, `florensky_sphere`, `godel_statement_plaque` |
| 16 | `qfeplaboratory` | `synthesis` | 8 | 8 | 0 | `QFEP_Introduction` | `bifurcation_walkway`, `chaos_particles`, `complexity_pattern`, `crystal_cluster` |
| 17 | `speculativecomputation` | `synthesis` | 5 | 5 | 0 | `SpeculativeComputation_Evolutionary_Algorithms` | `ca_rule_explorer` |
| 18 | `criticalalgorithms` | `synthesis` | 6 | 6 | 0 | `CriticalAlgorithms_Algorithmic_Misframing` | `bias_visualizer`, `bar_array_prime_sieve`, `mass_spring_damper` |
