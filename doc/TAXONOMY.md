...
| 3 | `wavefunctions` | `oscillation` | 12 | 12 | 0 | `WaveFunctions_Intro` | `living_paper_fourier`, `living_paper_heat`, `living_paper_lissajous`, `living_paper_sine` |
...
| 5 | `randomness` | `E_entropy` | 13 | 13 | 0 | `Random_Definition` | `grid3d_entropy`, `2d_in_3d_randomness_vis`, `GaussianBlurCircle`, `GaussianBlurShader` |
| 6 | `noise` | `E_entropy` | 11 | 11 | 0 | `Random_Noise_Types` | `flow_field_painter`, `perlin_terrain_sculptor`, `living_paper_noise_octaves`, `living_paper_perlin` |
| 7 | `cellularautomata` | `E_entropy` | 12 | 12 | 0 | `CA_1` | `living_paper_brians_brain`, `living_paper_life`, `living_paper_rule110`, `living_paper_rule30` |
| 8 | `fractals` | `lambda_edge` | 14 | 14 | 0 | `Fractals_1` | `living_paper_julia`, `living_paper_koch`, `living_paper_mandelbrot`, `living_paper_sierpinski` |
| 9 | `lsystems` | `lambda_edge` | 11 | 11 | 0 | `LSystems_Hilbert3D` | `living_paper_dragon`, `living_paper_fern`, `living_paper_tree`, `lsystem_editor` |
| 10 | `proceduralgeneration` | `lambda_edge` | 18 | 18 | 0 | `ProceduralGeneration_Two` | `grid3d`, `pixel_cloud`, `plane_manipulator`, `ten_print_maze_3d` |
...
| 18 | `criticalalgorithms` | `synthesis` | 6 | 6 | 0 | `CriticalAlgorithms_Algorithmic_Misframing` | `bar_array_prime_sieve`, `bias_visualizer`, `mass_spring_damper` |
