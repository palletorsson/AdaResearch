...
**Intent:** `grid colors`
**Matched topic:** `grid`
**Pack slug:** `grid-colors-test`
**Category:** `systems`
**Tags:** `grid, maps, layout, rendering, utilities`
**Generated:** `2026-04-04T11:50:59+00:00`
...
## Related Docs
- `doc/CLAUDE_PROJECT_NAVIGATOR.md` — Understanding this project requires distinguishing **what the map IS** from **what the map CONTAINS**.
...
- `doc/LAB_GRID_GUID.md` — # LabGrid System
...
- `doc/SCIENCE_SCREEN_SYSTEM.md` — The Science Screen is a **2D visualization surface that mirrors 3D VR interactions**. In VR, the player grabs a point, draws a line, builds a triangle. The Science Screen — a large monitor standing in the map — renders a
- `doc/CLAUDE_GUIDE_TO_PLAYING_ADA_RESEARCH.md` — **Ada Research Zero One** is a VR computational algorithm education system built in Godot 4.6 + XR Tools. It teaches algorithms through dual lenses: technical implementation + queer theory critique. Maps are designed as 

## Related Repo Paths
- `commons/maps/Color_Grid_Pallet/map_data.json`
- `commons/maps/Lab/map_data_post_color.json`
- `commons/maps/Shader_02_Colors/map_data.json`
- `commons/maps/Wavefunctions_Colors/map_data.json`
- `commons/maps/AdvancedLaboratory_Entropy_Visualization/map_data.json`
- `commons/maps/AdvancedLaboratory_Feedback_Cybernetics/map_data.json`
- `commons/maps/AdvancedLaboratory_Lab_Equipment_Simulation/map_data.json`
