...
**Generated:** `2026-04-04T11:50:57+00:00`
...
## Related Docs
- `doc/CLAUDE_PROJECT_NAVIGATOR.md` — | **E(S)** | System entropy (disorder, freedom) | Randomness, possibility space |
...
- `doc/CLAUDE_GUIDE_TO_PLAYING_ADA_RESEARCH.md` — This guide explains how to navigate and experience the Ada Research VR educational system by reading its source files.
...
- `commons/maps/Lab/map_data_post_lsystems.json`
