...
func _ready() -> void:
	...
	Stage.box(self,readout.position+Vector3(0,0,0.016),Vector3(1.55,0.25,0.035),Color(0.07,0.13,0.17))
...
func is_player(body: Node) -> bool:
	return body == museum.get("_player") if museum != null else body.is_in_group("player")
