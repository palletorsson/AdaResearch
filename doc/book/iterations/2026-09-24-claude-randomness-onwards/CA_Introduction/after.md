...
Find the board on your left as you come in, a few steps into the corridor on that side, near its outer wall. The newest row sits along its far edge; the rest of the board is room for a past. Three small marks pick out a cell and its two neighbours. Read their states on the side plate, but leave NEXT for a moment. What would you make from these three?
...
Go back out through the opening, cross the entrance to the board's corridor, and follow it past the agents painting a shared surface. Further along, the line network gives the cell another body. Occupied positions are joined by thin coloured lines, drawn as a tangle in the air above the floor. Move around it and let one apparent knot separate into lines at different depths. Some space that looked full can open when your viewpoint changes.
