# Eye shot — SwarmIntelligence_FlowFields
...
- **FlowFieldMain** — sequence_mode — switching between open field, U-wall, zig-zag, linear wind, and noise turbulence reveals how f
