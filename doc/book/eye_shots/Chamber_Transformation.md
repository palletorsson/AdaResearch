# Eye shot — Chamber_Transformation

> one pass: ride (gaze), move (place --only-improve), gate (pathfinder), voice (qfep). Field note, not a ruling.

## The ride (before)
clearance violations: **13 overlaps, 3 tight** — the law wants ≥1.2m to walk between.
- `[OVERLAP] becoming_catalyst#start_mode:transformation <-> catalyst_target            gap -2.26m (centers 2.24m)`
- `[OVERLAP] becoming_catalyst#start_mode:transformation <-> catalyst_target            gap -2.26m (centers 2.24m)`
- `[tight  ] becoming_catalyst#start_mode:transformation <-> catalyst_target            gap +0.89m (centers 5.39m)`
- `[tight  ] science_screen:180:1.5#mode:scatter <-> catalyst_target            gap +0.89m (centers 5.39m)`
- `[OVERLAP] science_screen:180:1.5#mode:scatter <-> catalyst_target            gap -2.26m (centers 2.24m)`
- `[OVERLAP] science_screen:180:1.5#mode:scatter <-> catalyst_target            gap -2.26m (centers 2.24m)`
...
## The move
    ...
    summary: 1 maps processed
      ...
      walkability improved: 1/1  mean Δ=+0.058

sibling **Trial_eye_Chamber_Transformation** kept: overlaps 13→1, tight 3→0, pathfinder OK.
