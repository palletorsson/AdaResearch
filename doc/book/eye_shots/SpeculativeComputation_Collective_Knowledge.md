# Eye shot — SpeculativeComputation_Collective_Knowledge
...
- **wiki_fragment** — the cross-reference footer on each panel ("→ see EAST · On Margins") — this directed cycle prevents any single
