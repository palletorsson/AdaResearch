...
## The move
    ...
    summary: 1 maps processed
      ...
      walkability improved: 1/1  mean Δ=+0.111
...
- **marchingcave** — A cave system marched at generation scale — the algorithm as land-maker, corridors and chambers emerging where
- **marchingcubes_cave** — The cave generator opened as an instrument: field in, fifteen cases per cell, mesh out. The pipeline of the wh
