# Eye shot — Boolean_Compose_Workbench
...
- **csg_compose_workbench** — All three operators on one bench — union, intersection, difference, side by side, the chapter's grammar laid o
