...
- `[OVERLAP] becoming_catalyst#start_mode:cellular <-> catalyst_target            gap -2.26m (centers 2.24m)`
- `[OVERLAP] becoming_catalyst#start_mode:cellular <-> catalyst_target            gap -2.26m (centers 2.24m)`
- `[tight  ] becoming_catalyst#start_mode:cellular <-> catalyst_target            gap +0.89m (centers 5.39m)`
...
sibling **Trial_eye_Chamber_CA** kept: overlaps 13→1, tight 3→0, pathfinder OK.
