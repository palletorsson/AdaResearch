...
## The move
    ...
    summary: 1 maps processed
      constraint improved: 1/1  mean Δ=+0.040
      walkability improved: 0/1  mean Δ=-0.323
...
- **ca_sphere** — f_order: an automaton wrapped on a sphere — the same neighborhood rule with no edge to hide at. On a closed su
- **rule_30_110_gravity** — lambda_edge: Rule 30 and Rule 110 under gravity — chaos and Turing-completeness made to fall. The two most fam
