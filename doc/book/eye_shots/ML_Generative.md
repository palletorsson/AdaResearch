...
- **generative_adversarial_networks_gans_vr** — Two networks locked in a duel — a generator forging samples, a discriminator calling the fakes — each making t
