# Eye shot — Symmetry_Seventeen

> one pass: ride (gaze), move (place --only-improve), gate (pathfinder), voice (qfep). Field note, not a ruling.

## The ride (before)
clearance violations: **0 overlaps, 1 tight** — the law wants ≥1.2m to walk between.
- `[tight  ] wall_pattern_gallery       <-> vr_tile_editor             gap +0.64m (centers 3.32m)`

## The move
    logged 1 entries to ada_run\placement_log.json
    summary: 1 maps processed
      constraint improved: 0/1  mean Δ=-0.038
      walkability improved: 0/1  mean Δ=-0.172
...
- **the writing's subjects are blocked in space**: vr_tile_editor, wall_pattern_gallery sit in clearance violations — the text promises what the floor obstructs.
