...
walked.md exists — the writing names 1/3 of the cast; dwells declared for 0.
- **the writing's subjects are blocked in space**: science_screen sit in clearance violations — the text promises what the floor obstructs.
- space without text: catalyst_target, proximity_spawner — standing in the room, absent from the walk.
