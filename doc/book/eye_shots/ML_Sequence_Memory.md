...
- **lstms_vr** — A memory cell you can walk through — gates deciding what to keep, what to forget, what to let out. The LSTM is
- **transformers_vr** — Attention drawn as beams — every token reaching to every other, weighting what matters, and the whole sequence
