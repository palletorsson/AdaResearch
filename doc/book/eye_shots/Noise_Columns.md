...
- **MeltingBerniniScene** — Bernini's columns dissolving under noise-driven vertex displacement: the baroque — history's most deliberate s
- **dark_sphere** — Transformation often needs an invariant reference to be legible. The sphere stays simple so surrounding change

## The text vs the space
walked.md exists — the writing names 2/2 of the cast; dwells declared for 0.
- **the writing's subjects are blocked in space**: MeltingBerniniScene, dark_sphere sit in clearance violations — the text promises what the floor obstructs.
