# Eye shot — Chamber_Random

> one pass: ride (gaze), move (place --only-improve), gate (pathfinder), voice (qfep). Field note, not a ruling.

## The ride (before)
clearance violations: **13 overlaps, 3 tight** — the law wants ≥1.2m to walk between.
- `[OVERLAP] becoming_catalyst#start_mode:chaos <-> catalyst_target            gap -2.26m (centers 2.24m)`
- `[OVERLAP] becoming_catalyst#start_mode:chaos <-> catalyst_target            gap -2.26m (centers 2.24m)`
- `[tight  ] becoming_catalyst#start_mode:chaos <-> catalyst_target            gap +0.89m (centers 5.39m)`
...
sibling **Trial_eye_Chamber_Random** kept: overlaps 13→1, tight 3→0, pathfinder OK.
