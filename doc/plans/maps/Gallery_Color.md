...
Showcase of 1 unplaced artifacts from Color. Walk through to browse available artifacts.

## Learning Objectives

- Browse 1 Color artifacts
...
|------|----------|----------|--------|
| [1,2] | request_note | tools | `:0:1.5#text:color space navigator` |
| [2,2] | color_space_navigator | color | `:0:-0.5` |
