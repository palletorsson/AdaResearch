# Map: TestMap_Unused_8

## Overview

**Dimensions:** 5 x 5 (max height: 3)

Test map for artifacts: height_random, instancingscatter, john_cage_tech_noir, kusama_sine
...
|------|----------|----------|--------|
| [1,1] | height_random | procedural | `:0:2` |
| [1,3] | instancingscatter | procedural | `:0:2` |
