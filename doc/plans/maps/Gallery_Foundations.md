# Map: Gallery: Foundations

> Foundations Artifact Gallery
...
Showcase of 1 unplaced artifacts from Foundations. Walk through to browse available artifacts.

## Learning Objectives

- Browse 1 Foundations artifacts
...
|------|----------|----------|--------|
| [1,2] | request_note | tools | `:0:1.5#text:hilbert hotel` |
| [2,2] | hilbert_hotel | philosophy | `:0:-0.5` |
