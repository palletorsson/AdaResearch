# Map: Gallery: Arrays_3

> Arrays_3 Artifact Gallery
...
Showcase of 1 unplaced artifacts from Arrays_3. Walk through to browse available artifacts.

## Learning Objectives

- Browse 1 Arrays_3 artifacts
...
|------|----------|----------|--------|
| [1,2] | request_note | tools | `:0:1.5#text:windmill floor` |
| [2,2] | windmill_floor | primitives | `:0:-0.5` |
