# Map: TestMap_Unused_4

## Overview

**Dimensions:** 5 x 5 (max height: 3)

Test map for artifacts: blue_noise, bubbles_random, cloudvolume, coshlea
...
|------|----------|----------|--------|
| [1,1] | blue_noise | procedural | `:0:2` |
| [1,3] | bubbles_random | procedural | `:0:2` |
| [3,3] | coshlea | wavefunctions | `:0:2` |
