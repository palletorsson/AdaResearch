# Map: TestMap_Unused_10

## Overview

**Dimensions:** 5 x 5 (max height: 5)

Test map for artifacts: neon_wave_grid, noir_sequencer, noise_terrain, noise_terrain_with_blobs
...
|------|----------|----------|--------|
| [1,1] | neon_wave_grid | procedural | `:0:2` |
| [3,3] | noise_terrain_with_blobs | procedural | `-` |
