...
Showcase of 1 unplaced artifacts from Nature. Walk through to browse available artifacts.

## Learning Objectives

- Browse 1 Nature artifacts
...
|------|----------|----------|--------|
| [1,2] | request_note | tools | `:0:1.5#text:critter placer` |
| [2,2] | critter_placer | nature_system | `:0:-0.5` |
