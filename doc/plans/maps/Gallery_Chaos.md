...
Showcase of 1 unplaced artifacts from Chaos. Walk through to browse available artifacts.

## Learning Objectives

- Browse 1 Chaos artifacts
...
|------|----------|----------|--------|
| [1,2] | request_note | tools | `:0:1.5#text:lyapunov exponents` |
| [2,2] | lyapunov_exponents | chaos | `:0:-0.5` |
