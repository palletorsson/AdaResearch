...
CATALOG = [
 ...
 ("change","sampling","the finite difference","the instantaneous derivative","a rate measured over one frame","zoom — the smooth curve is a chord-staircase (Zeno)",None,None),
 ...
 ("noise","determinism","the entropy floor","real chaos","gradient noise (Perlin is a crank too)","push structure toward max entropy — it collapses into the field",None,None),
 ("cellularautomata","determinism","deterministic random","a living/random field","a fully deterministic rule; a torus faking the plane","rewind Rule 30's seed — it repeats; Life breaks at the edge",None,None),
 ...
 ("lsystems","depth-cap","grammar as seed","an organic infinite plant","a deterministic unfolding of a tiny string","the forest is one seed; growth halts at the budget",None,None),
 ...
 ("softbodies","lattice","the mass-spring lattice","an elastic continuum","point masses on springs","squeeze — it is faceted; stiffen — it detonates",None,None),
 ("isosurfaces","lattice","marching cubes","a smooth implicit surface","triangles guessed between grid samples","lower the resolution — the blob turns to lego",None,None),
 ...
 ("machinelearning","compression","the model is the seam","understanding","a compressed table interpolated","off its training set it is confident and wrong — Ada reading herself",None,None),
