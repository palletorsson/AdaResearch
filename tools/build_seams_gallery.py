...
CATALOG = [
 ...
 ("symmetry","lattice","finite symmetry","continuous symmetry","n-fold; exactly 17 wallpaper groups","try to make a pattern outside the 17 rooms","wallpaper_cage",None),
 ...
 ("proceduralgeneration","depth-cap","the seed is the world","infinite variety","a finite formula generated on demand","walk away and back — recreated identically from its seed","seed_world",None),
