    ...
    for pi, p in enumerate(pearls_all):
        ...
        if p.get("ordered"):
            ...
            walks.append({"chapter": chapter, "pearl": name, "pearl_index": int(p.get("index", len(walks))), "map": p.get("map", ""),
                          "stages": list(p.get("stages", [])), "gaps": list(p.get("gaps", [])),
        ...
        walks.append({"chapter": chapter, "pearl": name, "pearl_index": int(p.get("index", len(walks))), "map": p.get("map", ""), "stages": list(p.get("stages", [])), "gaps": list(p.get("gaps", [])), "rooms": p.get("rooms"), "exclude": list(p.get("excluded", [])),
