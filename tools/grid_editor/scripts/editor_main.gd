...
# ============================================================
# GLASS ELEMENT GENERATORS — delegated to GlassMeshFactory
# ============================================================
...
func _create_glass_segment(element: Dictionary, grid_size: float) -> Node3D:
	...
	return MeshFactory.create_glass_segment(element, grid_size, tube_radius)

func _create_placeholder_3d(element: Dictionary, grid_size: float) -> Node3D:
	return MeshFactory.create_placeholder(element, grid_size)
