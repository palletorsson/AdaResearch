...
FORCE = {
  "axiom_bench": ("Axiom & production rules", "medium"),
  "axiom_room": ("Axiom & production rules", "large"),
  "generations_bench": ("Parallel rewriting / generations", "medium"),
  "generations_room": ("Parallel rewriting / generations", "large"),
  "growth_animator": ("Parallel rewriting / generations", "applied"),
  "grammar_bench": ("Formal grammars (Chomsky)", "medium"),
  "chomsky_room": ("Formal grammars (Chomsky)", "large"),
  "parse_tree_tool": ("Formal grammars (Chomsky)", "applied"),
  "turtle_bench": ("Turtle interpretation", "medium"),
  "turtle_room": ("Turtle interpretation", "large"),
  "turtle_plotter": ("Turtle interpretation", "applied"),
  "koch_loom": ("Koch & fractal curves", "applied"),
  "dragon_bench": ("Dragon & classic curves", "medium"),
  "dragon_room": ("Dragon & classic curves", "large"),
  "curve_plotter": ("Dragon & classic curves", "applied"),
  "hilbert_bench": ("Space-filling curves (Hilbert)", "medium"),
  "hilbert_room": ("Space-filling curves (Hilbert)", "large"),
  "bracket_bench": ("Bracketed branching", "medium"),
  "bracket_room": ("Bracketed branching", "large"),
  "bracket_pruner": ("Bracketed branching", "applied"),
  "lsystem_tree_room": ("L-system trees", "large"),
  "tree_nursery": ("L-system trees", "applied"),
  "fern_bench": ("Ferns & self-similar plants", "medium"),
  "fern_room": ("Ferns & self-similar plants", "large"),
  "fern_press": ("Ferns & self-similar plants", "applied"),
  "coral_bench": ("Coral & vines", "medium"),
  "coral_room": ("Coral & vines", "large"),
  "vine_grower": ("Coral & vines", "applied"),
  "stochastic_toy": ("Stochastic L-systems", "small"),
  "stochastic_bench": ("Stochastic L-systems", "medium"),
  "stochastic_room": ("Stochastic L-systems", "large"),
  "stochastic_seeder": ("Stochastic L-systems", "applied"),
  "parametric_bench": ("Parametric L-systems", "medium"),
  "parametric_room": ("Parametric L-systems", "large"),
  "parametric_designer": ("Parametric L-systems", "applied"),
  "context_toy": ("Context-sensitive L-systems", "small"),
  "context_room": ("Context-sensitive L-systems", "large"),
  "context_pruner": ("Context-sensitive L-systems", "applied"),
  "substrate_bench": ("Many substrates (the bridge)", "medium"),
  "substrate_room": ("Many substrates (the bridge)", "large"),
  "substrate_switcher": ("Many substrates (the bridge)", "applied"),
  "city_toy": ("Grammar architecture (cities/dungeons)", "small"),
  "city_bench": ("Grammar architecture (cities/dungeons)", "medium"),
  "city_room": ("Grammar architecture (cities/dungeons)", "large"),
  "sapling_toy": ("Forest & ecology (biome)", "small"),
  "forest_bench": ("Forest & ecology (biome)", "medium"),
  "grove_room": ("Forest & ecology (biome)", "large"),
  "dna_sprout": ("CritterDNA -> L-system tree", "small"),
  "genome_bench": ("CritterDNA -> L-system tree", "medium"),
  "seed_vs_random": ("CritterDNA -> L-system tree", "large"),
}
