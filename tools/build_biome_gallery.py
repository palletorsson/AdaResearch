...
KINGDOMS = [
    {"id": "flora", "name": "Flora", "color": "#59bf59",
     ...
     "algos": [
         ...
         {"algo": "sdf", "renders": "SDF tree — recursive branch skeleton smooth-unioned into ONE trunk (branches weld, no seams) under a solid canopy blob", "token": "flora:sdf:seed:t=5"},
     ]},
    {"id": "fungus", "name": "Fungus", "color": "#a674cc",
     ...
     "algos": [
         ...
         {"algo": "sdf", "renders": "SDF mushroom — cap and stem are one continuous smooth-unioned surface (the dome flows into the stem with no join)", "token": "fungus:sdf:seed:t=4"},
     ]},
    {"id": "fauna", "name": "Fauna", "color": "#e5994d",
     "blurb": "Creatures. A DNA-driven grub whose body is an SDF — spine capsules, head and leg nubs smooth-unioned into ONE watertight surface (marching tetrahedra), so there are no joint holes where the old segmented tubes used to gap. Biome-compact so it fits its cell.",
     "algos": [
         {"algo": "dna", "renders": "SDF creature — one continuous smooth-unioned body, head + eyes + blended leg nubs", "token": "fauna:dna:seed:t=4"},
     ]},
...
EXAMPLES = [
    ...
    {"slug": "fauna_grub", "group": "substrate", "token": "fauna:dna:seed:t=4",
     "caption": "the creature — a cell-sized SDF grub (one continuous body, no joint holes)"},
    {"slug": "flora_sdf_tree", "group": "substrate", "token": "flora:sdf:seed:t=5",
     "caption": "the SDF tree — branches weld into one continuous trunk, a solid canopy above"},
    {"slug": "fungus_sdf", "group": "substrate", "token": "fungus:sdf:seed:t=4",
     "caption": "the SDF mushroom — cap flows into stem, one continuous surface"},
...
DETAILS = [
    ...
    {"slug": "fd_alien_lumen", "kingdom": "fungus", "token": "fungus:dna:seed:fd=alien_lumen:t=3", "cell": [3, 1],
     "caption": "alien lumen — bioluminescent caps (auto-improved variant)"},
    {"slug": "fd_button_dome", "kingdom": "fungus", "token": "fungus:dna:seed:fd=button_dome:t=3", "cell": [3, 1],
     "caption": "button dome — low round caps (12 variants; this cell samples the auto-improved one)"},
    {"slug": "fd_fairy_ring", "kingdom": "fungus", "token": "fungus:dna:seed:fd=fairy_ring:t=3", "cell": [3, 1],
     "caption": "fairy ring — colony in a circle (auto-improved variant)"},
    {"slug": "fd_parasol_tall", "kingdom": "fungus", "token": "fungus:dna:seed:fd=parasol_tall:t=3", "cell": [3, 1],
     "caption": "tall parasol — high stem, wide cap (auto-improved variant)"},
    {"slug": "fd_shelf_bracket", "kingdom": "fungus", "token": "fungus:dna:seed:fd=shelf_bracket:t=3", "cell": [3, 1],
     "caption": "shelf bracket — stacked ledges (auto-improved variant)"},
