...
FORCE = {
  "mc_field_bench": ("Marching cubes", "medium"),
  "sdf_blob_toy": ("SDF sculpting", "small"),
  "sdf_sculpt_bench": ("SDF sculpting", "medium"),
  "sdf_cavern_room": ("SDF sculpting", "large"),
  "wfc_tile_bench": ("Wave function collapse", "medium"),
  "wfc_room_bench": ("WFC structures & rooms", "medium"),
  "wfc_dungeon_room": ("WFC structures & rooms", "large"),
  "bsp_toy": ("Boolean & space partition", "small"),
  "bsp_bench": ("Boolean & space partition", "medium"),
  "bsp_floorplan_tool": ("Boolean & space partition", "applied"),
  "colonization_bench": ("Space colonization", "medium"),
  "colonization_room": ("Space colonization", "large"),
  "colonization_grower": ("Space colonization", "applied"),
  "genome_toy": ("Genetic & evolutionary", "small"),
  "genetic_bench": ("Genetic & evolutionary", "medium"),
  "genetic_breeder": ("Genetic & evolutionary", "applied"),
  "slime_toy": ("Slime, DLA & aggregation", "small"),
  "slime_bench": ("Slime, DLA & aggregation", "medium"),
  "slime_farm": ("Slime, DLA & aggregation", "applied"),
  "voronoi_bench": ("Voronoi & Delaunay", "medium"),
  "voronoi_shatter_tool": ("Voronoi & Delaunay", "applied"),
  "markov_generator": ("Markov & probabilistic grammars", "applied"),
  "mesh_grammar_bench": ("Mesh & shape grammars", "medium"),
  "mesh_grammar_room": ("Mesh & shape grammars", "large"),
  "tiling_bench": ("Tilings & symmetry", "medium"),
  "tesseract_bench": ("Higher-dimensional generation", "medium"),
  "terrain_world_generator": ("Generated worlds", "applied"),
  ...
  "poisson_scatter_toy": ("Poisson-disk & scatter", "small"),
  "poisson_scatter_bench": ("Poisson-disk & scatter", "medium"),
  "poisson_forest_scatter": ("Poisson-disk & scatter", "applied"),
}
