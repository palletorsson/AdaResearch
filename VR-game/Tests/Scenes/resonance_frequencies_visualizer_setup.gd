...
# Variable declarations at the class level - add or update this

var particles_instance: GPUParticles3D = null  # Add separate variable for particles
...
func update_3d_field_visualization():
	...
	var process_material = particles_instance.process_material
