...
@onready var boid_manager = "res://adaresearch/Tests/Scenes/boid_manager.tscn"
...
func find_boid_manager():
	...
	return find_node_with_script(root, "BoidManager") or find_node_with_script(root, "res://adaresearch/Tests/Scenes/boid_manager.gd")
