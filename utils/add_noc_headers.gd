...
# ===========================================================================
# NOC Header Addition Tool
# Automatically adds standardized headers to all NOC example files
# ===========================================================================
...
func _init():
	print("NOC Header Addition Tool - Starting...")
	add_headers_to_all_files()
	print("NOC Header Addition Tool - Complete!")
	quit()
