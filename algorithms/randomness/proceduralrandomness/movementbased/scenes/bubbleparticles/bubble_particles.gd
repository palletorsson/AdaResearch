...
# var sound_synthesizer: BubbleSoundSynthesizer  # TODO: Implement BubbleSoundSynthesizer class
var sound_synthesizer
...
func _ready():
	...
	if use_synthesized_sounds:
		# TODO: Implement BubbleSoundSynthesizer class
