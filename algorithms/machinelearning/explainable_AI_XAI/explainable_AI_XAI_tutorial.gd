...
var text = '''
[center][b]Explainable AI (XAI)[/b][/center]
[center][i]Inside Explainable AI (XAI)[/i][/center]

This tutorial card summarizes how `res://algorithms/machinelearning/explainable_AI_XAI/ExplainableAIXAI.gd` orchestrates the scene so you can teach the concept without leaving VR.
