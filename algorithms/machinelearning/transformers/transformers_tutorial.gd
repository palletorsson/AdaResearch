...
var text = '''
[center][b]Transformers[/b][/center]
[center][i]Inside Transformers[/i][/center]

This tutorial card summarizes how `res://algorithms/machinelearning/transformers/Transformers.gd` orchestrates the scene so you can teach the concept without leaving VR.
