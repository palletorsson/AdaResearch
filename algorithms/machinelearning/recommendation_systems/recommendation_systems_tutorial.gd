...
[center][i]Inside Recommendation Systems[/i][/center]

This tutorial card summarizes how `res://algorithms/machinelearning/recommendation_systems/RecommendationSystems.gd` orchestrates the scene so you can teach the concept without leaving VR.
...
- `[code]create_user_particles()[/code]` handles a key part of the simulation loop.
