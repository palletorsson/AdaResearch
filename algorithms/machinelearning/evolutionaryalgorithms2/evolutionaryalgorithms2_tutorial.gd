...
var text = '''
[center][b]Evolutionary Algorithms 2[/b][/center]
[center][i]Inside Evolutionary Algorithms 2[/i][/center]

This tutorial card summarizes how `res://algorithms/machinelearning/evolutionaryalgorithms2/scripts/creature.gd` orchestrates the scene so you can teach the concept without leaving VR.
