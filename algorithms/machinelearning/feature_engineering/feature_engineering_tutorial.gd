...
[center][i]Inside Feature Engineering[/i][/center]

This tutorial card summarizes how `res://algorithms/machinelearning/feature_engineering/FeatureEngineering.gd` orchestrates the scene so you can teach the concept without leaving VR.
...
- `[code]create_raw_particles()[/code]` handles a key part of the simulation loop.
