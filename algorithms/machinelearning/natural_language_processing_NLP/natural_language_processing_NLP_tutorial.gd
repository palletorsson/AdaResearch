...
var text = '''
[center][b]Natural Language Processing (NLP)[/b][/center]
[center][i]Inside Natural Language Processing (NLP)[/i][/center]

This tutorial card summarizes how `res://algorithms/machinelearning/natural_language_processing_NLP/NaturalLanguageProcessingNLP.gd` orchestrates the scene so you can teach the concept without leaving VR.
...
- `[code]create_text_particles()[/code]` handles a key part of the simulation loop.
