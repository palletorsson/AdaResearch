...
var text = '''
[center][b]Optimization Algorithms[/b][/center]
[center][i]Inside Optimization Algorithms[/i][/center]

This tutorial card summarizes how `res://algorithms/machinelearning/optimization_algorithms/OptimizationAlgorithms.gd` orchestrates the scene so you can teach the concept without leaving VR.
