...
[center][i]Inside Computer Vision[/i][/center]

This tutorial card summarizes how `res://algorithms/machinelearning/computer_vision/ComputerVision.gd` orchestrates the scene so you can teach the concept without leaving VR.
...
- `[code]create_image_pixels()[/code]` handles a key part of the simulation loop.
