...
func _on_resolution_changed(value) -> void:
...
func _on_num_seeds_changed(value) -> void:
...
func _on_render_mode_selected(index) -> void:
	voronoi_node.render_mode = index
	voronoi_node.visualize_samples()

func _on_show_seeds_toggled(button_pressed) -> void:
	voronoi_node.show_seeds = button_pressed
	voronoi_node.visualize_samples()

func _on_smooth_normals_toggled(button_pressed) -> void:
	voronoi_node.smooth_normals = button_pressed
	voronoi_node.visualize_samples()

func _on_resolution_drag_ended(value_changed) -> void:
	if value_changed:
		voronoi_node.generate_voronoi()

func _on_num_seeds_drag_ended(value_changed) -> void:
	if value_changed:
		voronoi_node.generate_voronoi()
