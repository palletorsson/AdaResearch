# res://algorithms/proceduralgeneration/constraint_solvers/wfcRooms/wfc_office_generator.gd
...
@export var tiles_scene_path : String = "res://algorithms/proceduralgeneration/constraint_solvers/wfcRooms/OfficeTiles.tscn"
