...
func become_y_dummy_of(voxel: Voxel, offset: float) -> void:
	state = voxel.state
...
func become_xy_dummy_of(voxel: Voxel, offset: float) -> void:
	state = voxel.state
