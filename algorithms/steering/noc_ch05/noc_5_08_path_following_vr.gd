# ===========================================================================
# NOC Example 5.08: Path Following
...
func _spawn_vehicles() -> void:
	for i in num_vehicles:
		...
		v.velocity = Vector3(randf_range(-0.1, 0.3), randf_range(-0.1, 0.1), 0)
		v.max_speed = randf_range(0.25, 0.55)
		v.max_force = randf_range(0.04, 0.1)
...
func _process(delta: float) -> void:
	...
	_status_label.text = "Path Following | %d vehicles" % _vehicles.size()
...
class Vehicle:
	...
	func follow(path: PathFollowing3D) -> void:
