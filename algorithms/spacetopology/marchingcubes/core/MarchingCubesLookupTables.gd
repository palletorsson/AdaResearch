...
# Contains edge and triangle configurations for all 256 possible cube states

extends RefCounted
class_name MarchingCubesLookupTables

# Complete edge table - which edges of the cube are intersected by the isosurface
# All 256 entries for complete marching cubes implementation
...
# Complete triangle table - defines which triangles to draw for each configuration
# All 256 entries with proper triangle configurations
...
static var edge_connections: Array[Array] = [
...
static func get_cube_vertices() -> Array[Vector3]:
	return cube_vertices

static func get_edge_connections() -> Array[Array]:
	return edge_connections

static func interpolate_vertex(p1: Vector3, p2: Vector3, val1: float, val2: float, threshold: float = 0.5) -> Vector3:
	...
	var mu = (threshold - val1) / (val2 - val1)
	return p1 + mu * (p2 - p1) 