...
var _track_buttons: Array[Node3D] = []
var _track_labels: Array[Label3D] = []
var _stop_btn: Node3D
var _concept_label: Label3D
...
func _on_track_selected(track_id: int) -> void:
	...
	_status_label.modulate = Color(1.0, 0.8, 0.3)
