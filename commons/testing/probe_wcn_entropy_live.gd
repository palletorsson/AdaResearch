## LIVE PORT — generated by tools/port_wcn_probes_live.py from probe_wcn_entropy.gd. Do not edit;
## edit the SceneTree probe and regenerate. Runs under project startup (probe_live.tscn
## with --probe=entropy), so the project's autoloads exist and XR Tools pickables compile.
...
func _finish() -> void:
	...
	var f := FileAccess.open(OUT + "probe_entropy_live.json", FileAccess.WRITE)
