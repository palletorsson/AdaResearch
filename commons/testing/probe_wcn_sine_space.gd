...
func run() -> void:
	...
	if _live():
		...
		if "--capture" in OS.get_cmdline_user_args():
			...
			root.get_texture().get_image().save_png(OUT + "probe_sine_space_desktop_mid.png")
		...
		if "--capture" in OS.get_cmdline_user_args():
			...
			for i in range(15): await process_frame
			await create_timer(0.3, true, false, true).timeout
			root.get_texture().get_image().save_png(OUT + "probe_sine_space_desktop_exit.png")
	...
	if "--capture" in OS.get_cmdline_user_args():
		...
		await create_timer(0.3, true, false, true).timeout
		root.get_texture().get_image().save_png(OUT + "probe_sine_space_approach.png")
		...
		await create_timer(0.3, true, false, true).timeout
		root.get_texture().get_image().save_png(OUT + "probe_sine_space_inside.png")
		...
		if panel != null:
			...
			for i in range(20): cam.make_current(); await process_frame
			await create_timer(0.3, true, false, true).timeout
			root.get_texture().get_image().save_png(OUT + "probe_sine_space_panel.png")
		...
		for i in range(20): cam.make_current(); await process_frame
		await create_timer(0.3, true, false, true).timeout
		root.get_texture().get_image().save_png(OUT + "probe_sine_space_bridge.png")
		...
		for i in range(20): cam.make_current(); await process_frame
		await create_timer(0.3, true, false, true).timeout
		root.get_texture().get_image().save_png(OUT + "probe_sine_space_overview.png")
