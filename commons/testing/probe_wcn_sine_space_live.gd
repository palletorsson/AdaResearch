## LIVE PORT — generated by tools/port_wcn_probes_live.py from probe_wcn_sine_space.gd. Do not edit;
## edit the SceneTree probe and regenerate. Runs under project startup (probe_live.tscn
## with --probe=sine_space), so the project's autoloads exist and XR Tools pickables compile.
