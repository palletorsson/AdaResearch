...
#
# Legs at 45°/135°/225°/315° around body center, radius 2.2:
#   Leg 0 (front-right), Leg 1 (front-left), Leg 2 (back-left), Leg 3 (back-right)
...
# cos(45°)*2.2 ≈ 1.5556, body Y = 2.2 so offset Y = -2.2
var _shoulders: Array[Vector3] = [
	Vector3(1.5556, -2.2, -1.5556),   # Leg 0: front-right
	Vector3(-1.5556, -2.2, -1.5556),  # Leg 1: front-left
	Vector3(-1.5556, -2.2, 1.5556),   # Leg 2: back-left
	Vector3(1.5556, -2.2, 1.5556),    # Leg 3: back-right
]
...
func _ready() -> void:
	...
	# Body mesh
	var box := BoxMesh.new()
	box.size = Vector3(1.0, 0.3, 0.8)
	mesh = box
	var mat := StandardMaterial3D.new()
	mat.albedo_color = Color(0.25, 0.3, 0.4)
	...
	print("[FourLegCritter] Stepping gait ready — step_threshold=%.1f, step_duration=%.2f" % [
