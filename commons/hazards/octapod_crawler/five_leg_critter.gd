...
# Legs at 72° intervals, radius 2.2, body Y = 2.2 so offset Y = -2.2
# X = 2.2*cos(angle), Z = 2.2*sin(angle)
var _shoulders: Array[Vector3] = [
	Vector3(2.2, -2.2, 0.0),           # Leg 0: 0°
	Vector3(0.6798, -2.2, 2.0924),     # Leg 1: 72°
	Vector3(-1.7798, -2.2, 1.2944),    # Leg 2: 144°
	Vector3(-1.7798, -2.2, -1.2944),   # Leg 3: 216°
	Vector3(0.6798, -2.2, -2.0924),    # Leg 4: 288°
]
...
func _ready() -> void:
	...
	mat.albedo_color = Color(0.35, 0.25, 0.4)
