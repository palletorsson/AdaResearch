...
@export var base_color: Color = Color(1.0, 0.8, 0.2)
@export var dodecahedron_scale: float = 0.4:
	set(value):
		dodecahedron_scale = value
...
func _rebuild_dodecahedron() -> void:
