...
func create_pyramid_vertices() -> Array:
	...
	vertices.append_array([
		...
		Vector3(-half_base, 0, -half_base),  # 0: back-left
		Vector3(half_base, 0, -half_base),   # 1: back-right
		Vector3(half_base, 0, half_base),    # 2: front-right
		Vector3(-half_base, 0, half_base),   # 3: front-left
...
func set_pyramid_size(height: float, base: float):
