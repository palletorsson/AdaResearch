...
# Preset recipes — organized by topology behavior
# CLOSED = surface stays intact, OPEN = creates holes, MULTI = adds parts
const PRESETS: Array[Dictionary] = [
	# ── CLOSED manifolds (topology preserved) ──────────────
	{"name": "Extruded Spire (CLOSED)", "seed": 1, "gen": 1,
	 "extrude": 0.3, "extrude_scale": 0.7, "extrude_sel": 1},
	{"name": "Recursive Spire (CLOSED)", "seed": 1, "gen": 3,
	 "extrude": 0.2, "extrude_scale": 0.6, "extrude_sel": 1},
	{"name": "Inset Pattern (CLOSED)", "seed": 1, "gen": 1,
	 "inset": 0.35, "inset_sel": 0},
	{"name": "Inset Towers (CLOSED)", "seed": 0, "gen": 1,
	 "inset": 0.3, "inset_sel": 1, "extrude": 0.4, "extrude_scale": 0.7, "extrude_sel": 3},
	{"name": "Subdivided Smooth (CLOSED)", "seed": 1, "gen": 1,
	 "split": 1.0},
	{"name": "Nodule Sphere (CLOSED)", "seed": 2, "gen": 1,
	 "bulge": 0.15, "bulge_prob": 0.12},
	{"name": "Crumpled Form (CLOSED)", "seed": 2, "gen": 1,
	 "noise": 0.15, "noise_freq": 3.0},
	{"name": "Inset + Noise (CLOSED)", "seed": 1, "gen": 1,
	 "inset": 0.3, "inset_sel": 0, "noise": 0.08, "noise_freq": 2.0},
	{"name": "Extrude + Bulge (CLOSED)", "seed": 1, "gen": 2,
	 "extrude": 0.15, "extrude_scale": 0.8, "extrude_sel": 1, "bulge": 0.1, "bulge_prob": 0.08},
	# ── OPEN manifolds (delete creates holes) ──────────────
	{"name": "Budding Sphere (OPEN)", "seed": 2, "gen": 1,
	 "extrude": 0.2, "extrude_scale": 0.8, "extrude_sel": 2, "delete_top": 1.0},
	{"name": "Sea Sponge (OPEN)", "seed": 2, "gen": 2,
	 "extrude": 0.12, "extrude_scale": 0.7, "extrude_sel": 2, "delete_top": 1.0},
	# ── MULTI-component (adds separate parts) ─────────────
	{"name": "Coral Fingers (MULTI)", "seed": 2, "gen": 1,
	 "tube": 0.3, "tube_curve": 0.05},
	{"name": "Branching Coral (MULTI)", "seed": 1, "gen": 2,
	 "tube": 0.2, "tube_curve": 0.08},
	{"name": "Petal Flower (MULTI)", "seed": 1, "gen": 1,
	 "petal": 0.25, "petal_count": 6.0, "petal_curl": 0.4},
	{"name": "Blooming Bulge (MULTI)", "seed": 2, "gen": 1,
	 "bulge": 0.12, "bulge_prob": 0.08, "petal": 0.15, "petal_count": 5.0, "petal_curl": 0.5},
	{"name": "Scale Armor (MULTI)", "seed": 2, "gen": 1,
	 "split": 1.0, "scale_tile": 0.08},
	{"name": "Spike Ball (MULTI)", "seed": 1, "gen": 1,
	 "scatter": 0.6, "scatter_shape": 1.0, "scatter_size": 0.1},
	{"name": "Barnacle Sphere (MULTI)", "seed": 2, "gen": 1,
	 "scatter": 0.3, "scatter_shape": 0.0, "scatter_size": 0.03},
	{"name": "Riveted Sphere (MULTI)", "seed": 2, "gen": 1,
	 "extrude": 0.15, "extrude_scale": 0.75, "extrude_sel": 2, "delete_top": 1.0,
	 "scatter": 0.2, "scatter_shape": 0.0, "scatter_size": 0.02},
]
	...
	return [
		{"name": "Seed", "params": [
			{"id": "preset", "label": "Preset", "options": [
				"Custom",
				"Extruded Spire (CLOSED)", "Recursive Spire (CLOSED)",
				"Inset Pattern (CLOSED)", "Inset Towers (CLOSED)",
				"Subdivided Smooth (CLOSED)", "Nodule Sphere (CLOSED)",
				"Crumpled Form (CLOSED)", "Inset + Noise (CLOSED)",
				"Extrude + Bulge (CLOSED)",
				"Budding Sphere (OPEN)", "Sea Sponge (OPEN)",
				"Coral Fingers (MULTI)", "Branching Coral (MULTI)",
				"Petal Flower (MULTI)", "Blooming Bulge (MULTI)",
				"Scale Armor (MULTI)", "Spike Ball (MULTI)",
				"Barnacle Sphere (MULTI)", "Riveted Sphere (MULTI)",
			], "default": 0.0},
