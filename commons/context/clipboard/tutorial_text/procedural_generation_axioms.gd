...
res://algorithms/proceduralgeneration/spatial_partitioning/binary_space_partitioning/BinarySpacePartitioning.tscn demonstrates BSP-driven dungeon carving--recursive AABB splits stored in BinarySpacePartitioning.gd's all_cells become candidate rooms you can colorize, weight, or reserve for boss arenas. res://algorithms/proceduralgeneration/procedural_logic/mazegeneration/maze_generator.tscn animates recursive-backtracker corridors with walls, floor mesh, and collision toggles so the maze is immediately traversable. Organic complements live in res://algorithms/proceduralgeneration/isosurfaces/marchingcave/Scenes/marchingcubes_cave.tscn (signed-distance meshing, live material palette) and res://algorithms/proceduralgeneration/caverandomwalk/caverandomwalk.tscn (biased walkers carving caverns), letting you stitch rooms to caves without leaving the editor.
...
res://algorithms/proceduralgeneration/spatial_partitioning/poisson_disk_sampling_3d/PoissonDiskSampling3D.tscn (and PoissonDiskSamplingApplications.gd) exposes Bridson sampling sliders, boundary falloff modes, and radial statistics. Feed that point cloud to res://algorithms/proceduralgeneration/spatial_partitioning/voronoi_diagrams/voronoi_diagrams.tscn, res://algorithms/proceduralgeneration/spatial_partitioning/voronoi_diagram_3d/VoronoiDiagram3D.tscn, or res://algorithms/proceduralgeneration/spatial_partitioning/delaunay_triangulation_3d_cell/DelaunayTriangulation3DCell.tscn to study adjacency graphs, neighbors, and mesh extraction. When you need implicit surfaces, res://algorithms/proceduralgeneration/isosurfaces/metaballs/nakama_metaballs.tscn, res://algorithms/proceduralgeneration/metaballgenerator/metaballworld.tscn, res://algorithms/proceduralgeneration/isosurfaces/marchingsquares/marching_squares_scene.tscn, and the res://algorithms/proceduralgeneration/isosurfaces/marchingcave/Scenes/marchingcubes_* variants show how distance fields become clay, while res://algorithms/proceduralgeneration/hybrid_complex/wireframe/fatwireframe.tscn and res://algorithms/proceduralgeneration/hybrid_complex/layeredmembrane/layered_membrane.tscn visualize gradients and layer accumulation.
...
res://algorithms/l_systems/Growth/AnimatedTree.tscn decodes rewriting rules into branching meshes. res://algorithms/proceduralgeneration/growth_systems/branchinggrowthalgorithm/BranchingGrowthAlgorithm.tscn (and the continued study in branchinggrowthalgorithmcontinued) layers heuristics like tropism, pruning, and bud memory; res://algorithms/proceduralgeneration/growth_systems/space_colonization_algorithm/SpaceColonizationAlgorithm.tscn adds attraction volumes and thickness decay to steer branches around a cube, ring, or shell. Agent-based examples such as res://algorithms/proceduralgeneration/growth_systems/slimemold/slime.tscn, res://algorithms/proceduralgeneration/growth_systems/reactiondiffusion/2d_in_3d_turing_pattern_reaction_diffusion.tscn, res://algorithms/proceduralgeneration/growth_systems/percolationnetwork_ca/percolationnetwork_ca.tscn, res://algorithms/proceduralgeneration/growth_systems/crackpropagation_ca/crackpropagation_ca.tscn, and res://algorithms/proceduralgeneration/growth_systems/mirroredcellularautomata/mirrored_cellular_automata.tscn show how local diffusion, percolation thresholds, and mirrored rule tables yield vascular maps, Turing skins, or fracture webs.
...
var colonizer := preload("res://algorithms/proceduralgeneration/growth_systems/space_colonization_algorithm/SpaceColonizationAlgorithm.gd").new()
