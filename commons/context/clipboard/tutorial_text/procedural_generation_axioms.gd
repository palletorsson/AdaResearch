...
res://algorithms/proceduralgeneration/binary_space_partitioning/BinarySpacePartitioning.tscn demonstrates BSP-driven dungeon carving--recursive AABB splits stored in BinarySpacePartitioning.gd's all_cells become candidate rooms you can colorize, weight, or reserve for boss arenas. res://algorithms/proceduralgeneration/procedural_logic/mazegeneration/maze_generator.tscn animates recursive-backtracker corridors with walls, floor mesh, and collision toggles so the maze is immediately traversable. Organic complements live in res://algorithms/proceduralgeneration/marchingcave/Scenes/marchingcubes_cave.tscn (signed-distance meshing, live material palette) and res://algorithms/proceduralgeneration/caverandomwalk/caverandomwalk.tscn (biased walkers carving caverns), letting you stitch rooms to caves without leaving the editor.
