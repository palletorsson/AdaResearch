	...
	page_content = [
		...
		},
		{
			...
			"text": [
				...
				"",
				"CONSTANT GRAVITY (g â‰ˆ 9.8 m/sÂ²):",
				"Creates predictable parabolic trajectories, useful for:",
				"â€¢ Projectile motion in games (jump arcs, missile trajectories)",
				"â€¢ Rain, snow, and falling debris effects",
				"â€¢ Platformer game physics",
				"",
				"UNIVERSAL GRAVITATION:",
				"Follows Newton's formula: F = G(mâ‚mâ‚‚)/rÂ²",
				"This creates more complex behaviors:",
				"â€¢ Orbital mechanics (planets, satellites)",
				"â€¢ N-body simulations (star clusters, galaxies)",
				"â€¢ Gravitational slingshot effects",
				"",
				"CODE EXAMPLE:",
				"",
				"# Constant gravity",
		...
		},
		{
			...
			"text": [
				...
				"â€¢ Preventing perpetual motion (objects eventually stop)",
				"â€¢ Creating differences between surfaces (ice, grass, concrete)",
				"â€¢ Enabling controlled movement (like car steering)",
				"",
				"FRICTION TYPES:",
				"â€¢ Coulomb friction: F = Î¼N (proportional to normal force)",
				"â€¢ Drag friction: F = -cv (proportional to velocity)",
				"â€¢ Squared drag: F = -cvÂ² (proportional to velocity squared)",
				"",
		...
		},
		{
			...
			"text": [
				...
				"",
				"EXAMPLES:",
				"â€¢ Electromagnetism (charged particles, magnets)",
				"â€¢ Molecular bonds (attraction at certain distances, repulsion when too close)",
				"â€¢ Animal behaviors (flocking, predator avoidance)",
				"",
				"These forces typically follow variations of inverse square law: F âˆ 1/rÂ²",
				"",
				"The animation demonstrates particles responding to multiple attraction points, creating:",
				"â€¢ Stable orbits when velocity and attraction balance",
				"â€¢ Chaotic paths when multiple attractors compete",
				"â€¢ Oscillations around equilibrium points",
				"",
				"CODE EXAMPLE:",
				"",
		...
		},
		{
			...
			"text": [
				...
				"â€¢ Wind and fluid dynamics",
				"â€¢ Crowd movement patterns",
				"â€¢ Procedural terrain-aligned movement",
				"",
				...
				"â€¢ Particles moving through a wind field generated with Perlin noise",
				"â€¢ Particles responding to fluid resistance (stronger drag in \"water\" areas)",
				"â€¢ Particles following a radial field with turbulence",
				"",
				"CODE EXAMPLE:",
				"",
