...
# 
# ┌─────────────────────────────────────────────────────────────────────────┐
# │  ▶ 132 BPM    Bar: 47    Phrase: 12                    [TENSION] [DROP] │
# ├─────────────────────────────────────────────────────────────────────────┤
# │                                                                         │
# │  ┌─────────────────────────────────────────────────────────────────┐   │
# │  │  STEP: ● ○ ○ ○ │ ● ○ ○ ○ │ ● ○ ○ ○ │ ● ○ ○ ○                   │   │
...
# │                                                                         │
# │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐                  │
# │  │   909 KICK   │  │   909 HATS   │  │   303 ACID   │                  │
# │  │              │  │              │  │              │                  │
# │  │ PITCH [====] │  │ DECAY [==  ] │  │ CUTOFF ▓▓▓▓░░│ ← filter sweep   │
# │  │ DECAY [===  ]│  │ PATTERN [8th]│  │ RESO   ▓▓▓▓▓░│                  │
# │  │ PUNCH [==   ]│  │              │  │ ENV    ▓▓▓░░░│                  │
# │  │              │  │              │  │ ACCENT ▓▓▓░░░│                  │
# │  │ [▓▓▓▓▓░░░░░] │  │ [▓▓▓░░░░░░░] │  │ [▓▓▓▓▓▓▓░░░] │ ← levels        │
# │  └──────────────┘  └──────────────┘  └──────────────┘                  │
...
# │  ┌─────────────────────────────────────────────────────────────────┐   │
# │  │  ACID PATTERN:                                                   │   │
# │  │  A1 ·  A1 A2 │ A1 ·  A1 A1 │ A2 ·  A1 A1 │ A1 A2 ·  A1          │   │
# │  │  ●  ○  ○  ●  │ ●  ○  ○  ●  │ ○  ○  ●  ○  │ ●  ○  ●  ○   accents │   │
# │  │  ○  ○  ○  ↗  │ ○  ○  ○  ○  │ ↗  ○  ○  ○  │ ○  ↗  ○  ○   slides  │   │
# │  └─────────────────────────────────────────────────────────────────┘   │
# │                                                                         │
# │  ┌─────────────────────────────────────────────────────────────────┐   │
# │  │  MASTER: [▓▓▓▓▓▓▓▓░░] DRIVE [==] REVERB [=]    FILTER [▓▓▓▓▓▓▓]│   │
# │  └─────────────────────────────────────────────────────────────────┘   │
# │                                                                         │
# └─────────────────────────────────────────────────────────────────────────┘
...
func _on_phrase(phrase_num: int):
	pass
