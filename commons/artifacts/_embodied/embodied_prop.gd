...
## EmbodiedProp — lean shared base for free-world "force-display" props (lawn_mower,
## force_cube, bubble_gun). NOT a console: no rack. Just the procedural primitives,
## materials, a billboard readout, and settle. Toys extend this BY PATH and define
## their own _ready() -> _build().
