...
class_name Rule90Bench

## @identity
## lineage: Rule 90 — the XOR elementary CA, Pascal's triangle mod 2, the Sierpinski gasket made by hand-rule.
## essence: On a bench, a single seed grows generation by generation into the unmistakable Sierpinski triangle.
## truth: No fractal was specified — only "left XOR right". The shape was implied by three bits; the run reveals what the rule already contained.
...
var _rows: Array = []
var _alive_col: Color = Color(0.6, 0.8, 1.0, 1)
...
func _build() -> void:
	...
	add_child(_billboard_label("RULE 90 = SIERPINSKI\nthe fractal was in the rule", Vector3(0, 1.6, 0), 28, _alive_col))
