...
func _create_vr_controls():
	...
	_control_panel = RackTpl.create_panel("CROSS PRODUCT", [
		[{"type": "button", "label": "X*Z>Y"}, {"type": "button", "label": "Z*X>-Y"}, {"type": "button", "label": "X*Y>Z"}],
		[{"type": "button", "label": "3D"}, {"type": "button", "label": "RESET"}],
	])
	...
	var presets = [
		[Vector3(0.8, 0, 0), Vector3(0, 0, 0.8)],
		[Vector3(0, 0, 0.8), Vector3(0.8, 0, 0)],
		[Vector3(0.8, 0, 0), Vector3(0, 0.8, 0)],
		[Vector3(0.6, 0.4, 0.2), Vector3(0.2, 0.4, 0.6)],
		[Vector3(0.8, 0, 0), Vector3(0, 0, 0.8)],
	]
