...
func _create_vr_controls():
	...
	_r_min_slider.position = Vector3(-0.12, 0.01, -0.005)
	...
	_r_max_slider.position = Vector3(0.12, 0.01, -0.005)
	...
	preset_btn1.position = Vector3(-0.1, -0.035, -0.005)
	...
	preset_btn2.position = Vector3(0, -0.035, -0.005)
	...
	preset_btn3.position = Vector3(0.1, -0.035, -0.005)
