...
## The move
    ...
    summary: 1 maps processed
      constraint improved: 0/1  mean Δ=-0.021
      walkability improved: 0/1  mean Δ=-0.357
...
- **caverandomwalk** — A cave dug by a random walk — a wanderer eating rock as it drifts, and the tunnel it leaves behind is the cave
- **maze_generation** — A walkable maze carved by recursive backtracking — the algorithm drills forward at random, and when it hits a 
