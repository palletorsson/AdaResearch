...
## The move
    ...
    summary: 1 maps processed
      constraint improved: 1/1  mean Δ=+0.104
      walkability improved: 0/1  mean Δ=-0.318
...
- **KonigsbergBridge** — Pure F in negative form: the odd-degree pattern forbids an Eulerian walk. The artifact shows that some questio
- **graphspace** — Pure F: relation becomes architecture. Force balance reveals a stable spatial form for the graph, letting stru
