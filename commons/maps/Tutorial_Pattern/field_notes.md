...
Source: current arrangement retained; already assigned to tiling. Original size [10, 13]; enclosure [18, 21]; every original structure and utility cell preserved at offset (4,4). The real GridSystem retains grid-dependent colour behavior, inside perimeter walls, with no staged glass arena or fire.
