# Eye shot — SoftBody_gm04_pressed_onto_sphere
...
## The move
    placing 1 map(s)  ·  IN-PLACE mode
      SKIP Trial_eye_SoftBody_gm04_pressed_onto_sphere: no placeable artifacts found in Trial_eye_SoftBody_gm04_pressed_onto_sphere
