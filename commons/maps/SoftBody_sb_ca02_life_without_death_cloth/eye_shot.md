# Eye shot — SoftBody_sb_ca02_life_without_death_cloth
...
## The move
    placing 1 map(s)  ·  IN-PLACE mode
      SKIP Trial_eye_SoftBody_sb_ca02_life_without_death_cloth: no placeable artifacts found in Trial_eye_SoftBody_sb_ca02_life_without_death_cloth
    logged 0 entries to ada_run\placement_log.json
