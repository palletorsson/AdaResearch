...
Source: current arrangement retained; already assigned to tiling. Original size [11, 11]; enclosure [19, 19]; every original structure and utility cell preserved at offset (4,4). The real GridSystem retains grid-dependent colour behavior, inside perimeter walls, with no staged glass arena or fire.
