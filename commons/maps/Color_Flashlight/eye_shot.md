...
## The move
    placing 1 map(s)  ·  IN-PLACE mode
      SKIP Trial_eye_Color_Flashlight: no placeable artifacts found in Trial_eye_Color_Flashlight
...
## The voice (qfep)
0 of 0 cast members carry a theory-claim; 0 mute.
