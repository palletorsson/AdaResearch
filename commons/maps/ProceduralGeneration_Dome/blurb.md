...
Every procedural algorithm answers the same question: how much order can emerge from how little instruction? The arena strips this down to its bare mechanics. A few parameters. A bounded space. Infinite possible configurations. The grid doesn't care what grows in it. That's the point.