...
The max-flow min-cut theorem says the answer was always in the walls. Maximum flow equals the capacity of the cheapest way to sever source from sink. Optimization and destruction yield the same number. The most you can push through is exactly what it would cost to cut apart.

A funnel narrows. Feel the constraint tighten. What moves through a system is defined by what refuses to.