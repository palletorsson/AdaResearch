...
Nine grid agents patrol the floor. Copy, random, cellular automata, sine, array, color, rotate, scale, translate. Each mode rewrites the grid differently. Same walker, nine behaviors. The agent doesn't change — its operation does.

Every dangerous thing here is also useful. The constraint is yours.