...
Key artifacts: approach_wall (fifteen slats swinging out of the plane, aperture 1.3 m, reach 2.6 m); carve_grid (11x4x11 cubes at 0.34 m, bite 0.16 m, regrow 0 so the tunnel is permanent); approach_scale (nine blocks at 1.5 m spacing, 1.15 m each, shrinking to 0.34 of size within 2.2 m); dark_sphere at the far end, the chapter's own closing mark.
