...
PCA compresses from the other direction. High-dimensional data collapses onto its axes of greatest variance — the skeleton of the signal, everything else discarded. Reduction as a form of sight.

Two operations, one tension: descend to find structure, or compress to reveal it. Both navigate spaces too large to see whole. Both trust that the important thing is somewhere below — in the valley, in the principal axis, in the direction you can't yet name but your body already follows.