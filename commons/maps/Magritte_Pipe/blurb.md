...
Every data structure is a Magritte painting. The map is not the territory. The model is not the system. The menu is not the meal. Computation runs on signs detached from what they signify — and that detachment is not a flaw. It is the condition of all formal reasoning.