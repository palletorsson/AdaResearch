Concept: A grown map. The walker entered an empty bounding box, laid 100 floor cells as it walked, placed 14 artifacts with clearance (and 0 of them on tables for eye-level reading), and ended at the teleporter. The map is the record of the walk.
...
Key artifacts:
- softbody_gallery_part1
- softbody_gallery_part2
- softbody_gallery_part3
- softbodytest
