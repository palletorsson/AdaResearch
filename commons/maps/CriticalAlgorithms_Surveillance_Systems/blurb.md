...
Randomness is not the absence of structure. It is structure's raw material — the space before decision, where every outcome exists simultaneously. The algorithm doesn't find order. It performs the moment order precipitates from chaos.