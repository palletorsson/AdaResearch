Concept: A grown map. The walker entered an empty bounding box, laid 89 floor cells as it walked, placed 11 artifacts with clearance (and 0 of them on tables for eye-level reading), and ended at the teleporter. The map is the record of the walk.
...
- genetic_breeder
- slime_farm
- voronoi_shatter_tool
- poisson_forest_scatter
- markov_generator
- terrain_world_generator
- world_forge
- prefab_sculpture
- gray_scott_comparison
