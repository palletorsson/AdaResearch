Concept: The first instantiated point — position without extension, existence before duration — and the infrastructure (coordinate systems, render loops, void) that must precede it.
Sequence role: Opens the Primitives sequence. No predecessor. Establishes the zero-to-one act: the system was already running, the point is your first mark within it; leads to Point_Lines.
