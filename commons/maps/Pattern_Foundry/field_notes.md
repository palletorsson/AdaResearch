...
Source: current arrangement retained; already assigned to tiling. Original size [17, 30]; enclosure [25, 38]; every original structure and utility cell preserved at offset (4,4). The real GridSystem retains grid-dependent colour behavior, inside perimeter walls, with no staged glass arena or fire.
