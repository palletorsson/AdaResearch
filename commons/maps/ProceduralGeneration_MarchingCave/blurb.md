...
Walk through it. The ceiling drips with implicit mathematics. Every passage exists because density crossed zero at exactly that point — form crystallized at the threshold where inside stopped being outside.