# Eye shot — FormFinding_Catenary

> one pass: ride (gaze), move (place --only-improve), gate (pathfinder), voice (qfep). Field note, not a ruling.

## The ride (before)
clearance violations: **0 overlaps, 1 tight** — the law wants ≥1.2m to walk between.
- `[tight  ] catenoid                   <-> science_screen             gap +0.17m (centers 2.35m)`

## The move
    logged 1 entries to ada_run\placement_log.json
    summary: 1 maps processed
      constraint improved: 1/1  mean Δ=+0.086
      walkability improved: 0/1  mean Δ=-0.054
...
- **the writing's subjects are blocked in space**: catenoid sit in clearance violations — the text promises what the floor obstructs.
