Concept: A grown map. The walker entered an empty bounding box, laid 57 floor cells as it walked, placed 2 artifacts with clearance (and 0 of them on tables for eye-level reading), and ended at the teleporter. The map is the record of the walk.
