# Eye shot — SpeculativeComputation_Situated_Computation
...
## The move
    ...
    summary: 1 maps processed
      ...
      walkability improved: 0/1  mean Δ=-0.150
...
- **situated_readout** — global_position determines the verdict — there is no query; the coordinate IS the classification; the view alw
