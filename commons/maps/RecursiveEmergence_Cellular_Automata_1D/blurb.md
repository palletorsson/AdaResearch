...
Grab the automaton. Change the rule. Watch the corridor rewrite itself. The entire system fits in eight bits — a number smaller than your age — yet generates complexity no finite description can compress. Order doesn't scale into chaos. It *steps* there. One rule away.