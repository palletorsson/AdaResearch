...
But dependency is relational, not intrinsic. Nothing is "first" alone. Order emerges from constraint — from what each node needs before it can become available. The sort doesn't discover sequence. It produces it.